...
# Train Test Split
X_train, X_test, y_train, y_test = train_test_split(X,y,test_size=0.3) # 30% training and 70% test
print(X_train.shape)
print(y_train.shape)

model = RandomForestClassifier(n_estimators=20) # have 20 decision Trees all
